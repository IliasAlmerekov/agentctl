...
agentctl's beta scope is intentionally narrow: observe local Claude Code agents and provide the three controls already implemented by the CLI, `inject`, `cap`, and `kill`.
